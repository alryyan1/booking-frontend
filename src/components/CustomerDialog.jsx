...
import {
  ...
  TextField, Button, Box, Typography, Alert, Avatar,
...
const CustomerDialog = ({ open, onClose, onSave, customer = null }) => {
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)}>
        <DialogTitle sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid', borderColor: 'divider', py: 2.5, px: 3 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            <Avatar sx={{ bgcolor: customer ? 'info.light' : 'primary.light', color: customer ? 'info.main' : 'primary.main', width: 44, height: 44 }}>
            ...
            <Box>
              ...
              <Typography variant="caption" color="text.secondary" fontWeight="500">
                {customer ? 'Update customer information' : 'Fill in the details below'}
              </Typography>
            </Box>
          </Box>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3.5, mt: 1 }}>
                  ...
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start">
                        <PersonIcon color={errors.name ? "error" : "action"} fontSize="small" />
                      </InputAdornment>
                    ),
                    sx: { borderRadius: 2.5 }
                  }}
                ...
                {...register('phone_number', { 
                  ...
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start">
                        <PhoneIcon color={errors.phone_number ? "error" : "action"} fontSize="small" />
                      </InputAdornment>
                    ),
                    sx: { borderRadius: 2.5 }
                  }}
                ...
                <TextField
                  ...
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start">
                        <EmailIcon color={errors.email ? "error" : "action"} fontSize="small" />
                      </InputAdornment>
                    ),
                    sx: { borderRadius: 2.5 }
                  }}
        ...
        <DialogActions sx={{ p: 3, borderTop: '1px solid', borderColor: 'divider', gap: 1.5 }}>
          ...
          >
            {isSubmitting ? 'Saving...' : (customer ? 'Update Profile' : 'Save Customer')}
          </Button>
        </DialogActions>
      </form>
    </Dialog>
